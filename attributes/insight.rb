...
default['insight']['config']['api-revision'] = 'master'
default['insight']['config']['api-repository'] = 'https://github.com/bitpay/insight-api.git'
default['insight']['config']['ui-revision'] = 'master'
default['insight']['config']['ui-repository'] = 'https://github.com/bitpay/insight.git'
